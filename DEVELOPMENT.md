...
```bash
git remote add encore encore://crm-dashboard-system-fit2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/crm-dashboard-system-fit2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/crm-dashboard-system-fit2/settings/integrations/github)
